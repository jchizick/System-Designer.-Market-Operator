...
export function TopBar({ className = 'max-w-5xl' }: TopBarProps) {
  ...
  return (
    <header className={`flex flex-wrap items-start justify-between gap-x-4 gap-y-2 pb-3 border-b border-border-subtle mb-6 text-mono-xs text-text-secondary w-full ${className} mx-auto overflow-hidden`}>
