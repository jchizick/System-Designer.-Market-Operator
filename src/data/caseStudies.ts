...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    outcome: "Trading philosophy shaped into a decision system.",
    visualType: "wave",
    state: "LIVE",
  ...
  },
  {
    ...
    outcome: "Backcountry planning command center for camping operations.",
    visualType: "nodes",
    state: "LIVE BUILD",
  ...
  },
  {
    ...
    outcome: "Booking-focused client system with reduced friction.",
    visualType: "radar",
    state: "DEPLOYED",
